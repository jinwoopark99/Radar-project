...
def move_uav1():
    ...
    while not rospy.is_shutdown():
        ...
        if uav0_alive:
            ...
            relative_position.pose.position.y = recovery_position_2.pose.position.y - 1
            ...
            relative_position = PoseStamped()
            relative_position.pose.position.x = recovery_position_3.pose.position.x
            relative_position.pose.position.y = recovery_position_3.pose.position.y - 1
